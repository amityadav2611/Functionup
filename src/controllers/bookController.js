...
const authorModel = require("../models/authoursModel.js")
...
// const createAuthour= async function (req, res) {
//     let data= req.body
...
// const getCreateBook= async function (req, res) {
//     let allBooks= await BookModel.find( )
//     res.send({msg: allBooks})
// }

// const getCreateAuthour= async function (req, res) {
//     let allBooks= await BookModel.find( )
//     console.log(allBooks)
//     res.send({msg: allBooks})
// }
...
// module.exports.createAuthour= createAuthour

// module.exports.getCreateBook= getCreateBook

// module.exports.getCreateAuthour= getCreateAuthour
...
const allBooks1 = async function (req, res){
    const booksName = await authorModel.find()
...
const updateBookPrice = async function (req, res){
    ...
    const updatePrice = await bookModel.findOneAndUpdate({name:bkName}, {price:100},{new:true}).select({price:1, _id:0})
...
module.exports.allBooks1 = allBooks1
